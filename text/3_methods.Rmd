...
A online survey-experiment, on which this paper was based, concerning moral decision-making in the two hypothetical dilemmas was conducted over a period of one week. The studied subjects were chosen beforehand through dispension of digital invitations by members of the project group. Three hundred subjects were selected this way. As a result of the selection method, the sample reflects a very high percentage of students as well as a very low age and a political centre-left attitude on average (see below).

The pooled subjects were randomized into three groups each receiving a different treatment in between the first and the second query of a decision in the two scenarios. The two different dilemmas were the described ‘trolley dilemma‘ and ‘footbridge dilemma‘, also referred to as o  the ‘switch track’ and ‘push person’ dilemma, respectively (see appendix for original descriptions). For the first scenario, people were asked (translated from German): "Please imagine the following situation: A waggon is moving towards five persons, who are standing on the track and will be killed if nothing is done. Anna can redirect the waggon to a second track, rescuing all five persons. But on the second track, there is one uninvolved person. This person will die if the tracks are switched. To which degree is it morally justifiable for Anna to redirect the waggon onto the second track?" The second scenario differed in regard to the action Anna could take to stop the train: instead of switching tracks, she could push a person in front of the train to stop it, so the five persons would be rescued, but the pushed person would die."

Chosen subjects got to read a insertion text and had to fill in a survey regarding their general ethical position [cf. @forsyth1980taxonomy] as well as their personality and political attitudes. The they were asked to make a first decision in one of the two ethical dilemmas via dichotomous Yes/No choice and continuous tendency-rating, which will be used as the dependent variable in this paper. Afterwards each of the three groups received a treatment:
...
The dependent variable, the decision in one of two ethical dilemmas, was gathered in the form continuous tendency in regards to whether Anna's action of switching the tracks/pushing the person was morally justifiable (ranging from 1"Not at all", 6 “partly" to 11 “Absolutely") 
...
One example for such an (Idealism-)statement is:
...
Moreover, there are also differences between the experimental groups regarding the main independent variables Idealism and Relativism (see Figure 4). For relativism, these are not statistically significant, although the control group has a notably lower mean than discussion and information group. For idealism, the difference in means between the control group and the discussion (p = 0.092) and information group (p = 0.055) are significant on the 90%-level, indicating that these groups contain on average more idealistic persons. 


In sum, it can be concluded that the randomization into the three groups did not work out as intended. There are significant differences in means and different distributions of variables which are central to the analysis: gender,  relativism and the dependent variables, especially the Switch track variable. Concerning this issue, the following analysis should be interpreted with caution.


\begin{figure}[!h]
\label{gender_av_compare2}
	\caption{Randomization - Dependent Variables by Gender}
	\includegraphics[width=\textwidth]{images/gender_av_compare2}
	\flushright
{\scriptsize N = 278. Own calculations based on data from Online-Survey Experiment.\par}
\end{figure}

After the randomization was checked, some general descriptive statistics are reported. When it comes to the question of whether it is morally justifiable to switch the track or even push a person, there are differences in age and gender (see Figure 5). Older people as well as female persons consider both scenarios as less morally justified. Examining the values of both scenarios for men and women seperately, the differences are statistically significant in both scenarios with men being more likely to push and switch. Comparing the two scenarios shows that switching tracks is on average more likely to be considered  morally justifiable than pushing a person. 
