...
brm7 <- brm(t2_szenario1q2 ~ t1_szenario1q2 + akquisenz_pca + ideal_relativ_pca + general_group_discussion + general_group_information + gender + leftright + pol_interest + church_attendance + age + university + types, data = reg_dat)
...
brm8 <- brm(t2_szenario2q2 ~ t1_szenario2q2 + akquisenz_pca + ideal_relativ_pca + general_group_discussion + general_group_information + gender + leftright + pol_interest + church_attendance + age + university + types, data = reg_dat)
